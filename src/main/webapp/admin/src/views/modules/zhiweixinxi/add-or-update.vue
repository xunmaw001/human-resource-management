<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="职位名" prop="zhiweiming">
          <el-input v-model="ruleForm.zhiweiming" 
              placeholder="职位名" clearable  :readonly="ro.zhiweiming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="职位名" prop="zhiweiming">
              <el-input v-model="ruleForm.zhiweiming" 
                placeholder="职位名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='zhiweiming'){
            this.ruleForm.zhiweiming = obj[o];
	    this.ro.zhiweiming = true;
            continue;
          }
	                    }
                              }
