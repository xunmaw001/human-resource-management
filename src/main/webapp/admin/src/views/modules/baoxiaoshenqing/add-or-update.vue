          ...
          <el-form-item class="input" label="报销金额" prop="baoxiaojine">
              <el-input v-model="ruleForm.baoxiaojine" 
                placeholder="报销金额" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.fapiaoxiangqing" label="发票详情" prop="fapiaoxiangqing">
          <file-upload
          tip="点击上传发票详情"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.fapiaoxiangqing?ruleForm.fapiaoxiangqing:''"
          @change="fapiaoxiangqingUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.fapiaoxiangqing" label="发票详情" prop="fapiaoxiangqing">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fapiaoxiangqing.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                                                                                                        </el-row>
                                                                                                                                                                                                                                  <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="报销内容" prop="baoxiaoneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.baoxiaoneirong" label="报销内容" prop="baoxiaoneirong">
                    <span v-html="ruleForm.baoxiaoneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.baoxiaojine = true;
            continue;
	            	            ...
	            	            if(o=='fapiaoxiangqing'){
            this.ruleForm.fapiaoxiangqing = obj[o];
	    this.ro.fapiaoxiangqing = true;
            continue;
          }
	            	            	            	            if(o=='userid'){
	...
	this.ruleForm.baoxiaoneirong = this.ruleForm.baoxiaoneirong.replace(reg,'../../../ssmlq9t2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                                                ...
                                                                                                fapiaoxiangqingUploadChange(fileUrls) {
                this.ruleForm.fapiaoxiangqing = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                	addEditStyleChange() {
	  this.$nextTick(()=>{
