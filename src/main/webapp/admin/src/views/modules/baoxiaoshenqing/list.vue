		    ...
		    label="报销金额">
		     <template slot-scope="scope">
                       {{scope.row.baoxiaojine}}
                	                	                                      ...
                	                	                                      <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="fapiaoxiangqing"
                    header-align="center"
                    width="200"
                    label="发票详情">
                    <template slot-scope="scope">
                      <div v-if="scope.row.fapiaoxiangqing">
                        <img :src="scope.row.fapiaoxiangqing.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
                    ...
                    fapiaoxiangqing: row.fapiaoxiangqing,
                    sfsh: row.sfsh,
                    shhf: row.shhf,
                    userid: row.userid,
                    id: row.id
