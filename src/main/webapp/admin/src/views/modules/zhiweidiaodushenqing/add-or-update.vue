  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="职位" prop="zhiwei">
              <el-input v-model="ruleForm.zhiwei" 
                placeholder="职位" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="职位调度" prop="zhiweidiaodu">
          <el-select v-model="ruleForm.zhiweidiaodu" placeholder="请选择职位调度">
            <el-option
                v-for="(item,index) in zhiweidiaoduOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="职位调度" prop="zhiweidiaodu">
	      <el-input v-model="ruleForm.zhiweidiaodu"
                placeholder="职位调度" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="新部门" prop="xinbumen">
          <el-select v-model="ruleForm.xinbumen" placeholder="请选择新部门">
            <el-option
                v-for="(item,index) in xinbumenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="新部门" prop="xinbumen">
	      <el-input v-model="ruleForm.xinbumen"
                placeholder="新部门" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="新职位" prop="xinzhiwei">
          <el-select v-model="ruleForm.xinzhiwei" placeholder="请选择新职位">
            <el-option
                v-for="(item,index) in xinzhiweiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="新职位" prop="xinzhiwei">
	      <el-input v-model="ruleForm.xinzhiwei"
                placeholder="新职位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                      </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhiwei = true;
            continue;
	            	            ...
	            	            if(o=='zhiweidiaodu'){
            this.ruleForm.zhiweidiaodu = obj[o];
	    this.ro.zhiweidiaodu = true;
            continue;
          }
	            	            if(o=='xinbumen'){
            this.ruleForm.xinbumen = obj[o];
	    this.ro.xinbumen = true;
            continue;
          }
	            	            if(o=='xinzhiwei'){
            this.ruleForm.xinzhiwei = obj[o];
	    this.ro.xinzhiwei = true;
            continue;
          }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                    ...
                                                                                                                                    this.zhiweidiaoduOptions = "升职,离职,调职".split(',')
                                        this.$http({
              url: `option/bumenxinxi/bumenming`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.xinbumenOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
              ...
              if (data && data.code === 0) {
                this.xinzhiweiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
                                                                                                        ...
                                                                                                        // 多级联动参数
                                                                                                                                    info(id) {
      this.$http({
        url: `zhiweidiaodushenqing/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.shenqingyuanyin = this.ruleForm.shenqingyuanyin.replace(reg,'../../../ssmlq9t2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zhiweidiaodushenqing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhiweidiaodushenqingCrossAddOrUpdateFlag = false;
                  this.parent.search();
