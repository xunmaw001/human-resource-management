...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                ...
                                                                                                this.dangqianzhuangtaiOptions = "临时员工,正式员工".split(',')
                                        this.$http({
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zhengshiyuangong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhengshiyuangongCrossAddOrUpdateFlag = false;
                  this.parent.search();
