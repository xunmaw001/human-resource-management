<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="表" prop="biao">
          <el-input v-model="ruleForm.biao" 
              placeholder="表" clearable  :readonly="ro.biao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="表" prop="biao">
              <el-input v-model="ruleForm.biao" 
                placeholder="表" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="权限" prop="quanxian">
          <el-select v-model="ruleForm.quanxian" placeholder="请选择权限">
            <el-option
                v-for="(item,index) in quanxianOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="权限" prop="quanxian">
	      <el-input v-model="ruleForm.quanxian"
                placeholder="权限" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='biao'){
            this.ruleForm.biao = obj[o];
	    this.ro.biao = true;
            continue;
          }
	            	            if(o=='quanxian'){
            this.ruleForm.quanxian = obj[o];
	    this.ro.quanxian = true;
            continue;
          }
	                    }
                                              }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.quanxianOptions = "授权,不授权".split(',')
                            },
                        // 多级联动参数
                                info(id) {
      this.$http({
